...
public class DetectSwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
    ...
    private EventsActivity activity = null;

    public EventsActivity getActivity() {
        return activity;
    }

    public void setActivity(EventsActivity activity) {
        ...
        if((deltaXAbs >= MIN_SWIPE_DISTANCE_X) && (deltaXAbs <= MAX_SWIPE_DISTANCE_X))
        {
            ...
            else
            {
               // this.activity.displayMessage("Swipe to right");
                ...
                activity.overridePendingTransition(R.anim.slide_left,  R.anim.no_animation);
                activity.finish();
            }
        }
